...
const ::uint32_t TableStruct_coordinator_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    ...
    PROTOBUF_FIELD_OFFSET(::csce438::ServerInfo, _impl_.master_),
    PROTOBUF_FIELD_OFFSET(::csce438::ServerInfo, _impl_.clusterid_),
    PROTOBUF_FIELD_OFFSET(::csce438::ServerInfo, _impl_.connected_),
    ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        ...
        { 15, -1, -1, sizeof(::csce438::Confirmation)},
        { 24, -1, -1, sizeof(::csce438::ID)},
        { 33, -1, -1, sizeof(::csce438::Path)},
        { 42, -1, -1, sizeof(::csce438::PathAndData)},
        { 52, -1, -1, sizeof(::csce438::Status)},
};
...
const char descriptor_table_protodef_coordinator_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    ...
    "tobuf/timestamp.proto\"\202\001\n\nServerInfo\022\020\n\010"
    "serverID\030\001 \001(\005\022\020\n\010hostname\030\002 \001(\t\022\014\n\004port"
    "\030\003 \001(\t\022\014\n\004type\030\004 \001(\t\022\016\n\006master\030\005 \001(\010\022\021\n\t"
    "clusterID\030\006 \001(\005\022\021\n\tconnected\030\007 \001(\010\"\036\n\014Co"
    "nfirmation\022\016\n\006status\030\001 \001(\010\"\020\n\002ID\022\n\n\002id\030\001"
    " \001(\005\"\024\n\004Path\022\014\n\004path\030\001 \001(\t\")\n\013PathAndDat"
    "a\022\014\n\004path\030\001 \001(\t\022\014\n\004data\030\002 \001(\t\"\030\n\006Status\022"
    "\016\n\006status\030\001 \001(\0102\247\002\n\014CoordService\0229\n\tHear"
    "tbeat\022\023.csce438.ServerInfo\032\025.csce438.Con"
    "firmation\"\000\022/\n\tGetServer\022\013.csce438.ID\032\023."
    "csce438.ServerInfo\"\000\0220\n\nGetCluster\022\013.csc"
    "e438.ID\032\023.csce438.ServerInfo\"\000\0225\n\017GetSyn"
    "chronizer\022\013.csce438.ID\032\023.csce438.ServerI"
    "nfo\"\000\022B\n\024RegisterSynchronizer\022\023.csce438."
    "ServerInfo\032\023.csce438.ServerInfo\"\000b\006proto"
    "3"
};
...
ServerInfo::ServerInfo(const ServerInfo& from)
  ...
  ::memcpy(&_impl_.serverid_, &from._impl_.serverid_,
    ...
    reinterpret_cast<char*>(&_impl_.serverid_)) + sizeof(_impl_.connected_));
...
::uint8_t* ServerInfo::_InternalSerialize(
  ...
  if (this->_internal_master() != 0) {
    ...
    target = ::_pbi::WireFormatLite::WriteBoolToArray(
        5, this->_internal_master(), target);
  }
  ...
  if (this->_internal_clusterid() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(
        6, this->_internal_clusterid(), target);
  }
  ...
  if (this->_internal_connected() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(
        7, this->_internal_connected(), target);
  }
...
void ServerInfo::InternalSwap(ServerInfo* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ServerInfo, _impl_.connected_)
      + sizeof(ServerInfo::_impl_.connected_)
