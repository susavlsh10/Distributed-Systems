...
class ListReply final :
 ...
 public:
  ...
  void set_following(int index, const char* value, std::size_t size);
  void set_following(int index, absl::string_view value);
  ...
  void add_following(const char* value, std::size_t size);
  void add_following(absl::string_view value);
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& _internal_following() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* _internal_mutable_following();
...
// repeated string following = 3;
inline int ListReply::_internal_following_size() const {
  return _impl_.following_.size();
}
inline int ListReply::following_size() const {
  return _internal_following_size();
}
inline void ListReply::clear_following() {
  _internal_mutable_following()->Clear();
}
inline std::string* ListReply::add_following() {
  std::string* _s = _internal_add_following();
  // @@protoc_insertion_point(field_add_mutable:csce438.ListReply.following)
  return _s;
}
inline const std::string& ListReply::following(int index) const {
  // @@protoc_insertion_point(field_get:csce438.ListReply.following)
  return _internal_following(index);
}
inline std::string* ListReply::mutable_following(int index) {
  // @@protoc_insertion_point(field_mutable:csce438.ListReply.following)
  return _internal_mutable_following()->Mutable(index);
}
inline void ListReply::set_following(int index, const std::string& value) {
  _internal_mutable_following()->Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:csce438.ListReply.following)
}
inline void ListReply::set_following(int index, std::string&& value) {
  _internal_mutable_following()->Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:csce438.ListReply.following)
}
inline void ListReply::set_following(int index, const char* value) {
  ABSL_DCHECK(value != nullptr);
  _internal_mutable_following()->Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:csce438.ListReply.following)
}
inline void ListReply::set_following(int index, const char* value,
                              std::size_t size) {
  _internal_mutable_following()->Mutable(index)->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:csce438.ListReply.following)
}
inline void ListReply::set_following(int index, absl::string_view value) {
  _internal_mutable_following()->Mutable(index)->assign(value.data(),
                                                     value.size());
  // @@protoc_insertion_point(field_set_string_piece:csce438.ListReply.following)
}
inline void ListReply::add_following(const std::string& value) {
  _internal_mutable_following()->Add()->assign(value);
  // @@protoc_insertion_point(field_add:csce438.ListReply.following)
}
inline void ListReply::add_following(std::string&& value) {
  _internal_mutable_following()->Add(std::move(value));
  // @@protoc_insertion_point(field_add:csce438.ListReply.following)
}
inline void ListReply::add_following(const char* value) {
  ABSL_DCHECK(value != nullptr);
  _internal_mutable_following()->Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:csce438.ListReply.following)
}
inline void ListReply::add_following(const char* value, std::size_t size) {
  _internal_mutable_following()->Add()->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:csce438.ListReply.following)
}
inline void ListReply::add_following(absl::string_view value) {
  _internal_mutable_following()->Add()->assign(value.data(), value.size());
  // @@protoc_insertion_point(field_add_string_piece:csce438.ListReply.following)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
ListReply::following() const {
  // @@protoc_insertion_point(field_list:csce438.ListReply.following)
  return _internal_following();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* ListReply::mutable_following() {
  // @@protoc_insertion_point(field_mutable_list:csce438.ListReply.following)
  return _internal_mutable_following();
}
inline const std::string& ListReply::_internal_following(int index) const {
  return _internal_following().Get(index);
}
inline std::string* ListReply::_internal_add_following() {
  return _internal_mutable_following()->Add();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
ListReply::_internal_following() const {
  return _impl_.following_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
ListReply::_internal_mutable_following() {
  return &_impl_.following_;
}
