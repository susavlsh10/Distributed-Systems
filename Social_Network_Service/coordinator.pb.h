...
// bool master = 5;
inline void ServerInfo::clear_master() {
  _impl_.master_ = false;
}
inline bool ServerInfo::master() const {
  // @@protoc_insertion_point(field_get:csce438.ServerInfo.master)
  return _internal_master();
}
inline void ServerInfo::set_master(bool value) {
  _internal_set_master(value);
  // @@protoc_insertion_point(field_set:csce438.ServerInfo.master)
}
inline bool ServerInfo::_internal_master() const {
  return _impl_.master_;
}
inline void ServerInfo::_internal_set_master(bool value) {
  ;
...
// bool connected = 7;
inline void ServerInfo::clear_connected() {
  _impl_.connected_ = false;
}
inline bool ServerInfo::connected() const {
  // @@protoc_insertion_point(field_get:csce438.ServerInfo.connected)
  return _internal_connected();
}
inline void ServerInfo::set_connected(bool value) {
  _internal_set_connected(value);
  // @@protoc_insertion_point(field_set:csce438.ServerInfo.connected)
}
inline bool ServerInfo::_internal_connected() const {
  return _impl_.connected_;
}
inline void ServerInfo::_internal_set_connected(bool value) {
  ;
